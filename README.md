...
| **`prime`** | 质数筛 (Prime Sieve) | C++ / Java/c | 质数筛综合总结：试除法、埃氏筛、欧拉筛（线性筛），以及大数质数判定的 Miller-Rabin 算法。 | [🔗 前往 prime](https://github.com/xiao-meng-byte/gaussian-elimination/tree/prime) |
| **`fastpow`** | 快速幂 (Fast Power) | C++ / python | 快速幂原理学习：二进制拆分、乘法快速幂、快速乘防溢出，以及矩阵快速幂解决斐波那契/泰波那契/线性递推问题。 | [🔗 前往 fastpow](https://github.com/xiao-meng-byte/gaussian-elimination/tree/fastpow) |
